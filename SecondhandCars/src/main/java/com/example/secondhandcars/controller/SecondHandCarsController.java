...
public class SecondHandCarsController {
    ...
    //Named Parameter
    //127.0.0.1:8080/getNamedParameter/nissan
    ...
    //DML Delete Query
    //127.0.0.1:8080/deleteCarsByModel?model=Micra
    @DeleteMapping("/deleteCarsByModel")
    public String deleteCarByModel(@RequestParam String model)
    {
    int result=re.deleteCarByModel(model);
    if(result >0)
    ...
    //DML Update Query
    //127.0.0.1:8080/updateCarByColour/black/polo
    @PutMapping("/updateCarByColour/{colour}/{model}")
    public String updateCarByColour(@PathVariable String colour,@PathVariable String model)
    {
    int result=re.updateCarByModel(colour, model);
    if(result >0)
